...
<div class="px-14 mobile:px-4 w-full mobile:mt-4 max-h-[444px] h-[444px] bg-[#F9F8F1]"
...
<div class="px-14 py-24 bg-[#F9F8F1]">
    ...
    <div class="mt-16 max-h-[550px] ">
        <div
            class="relative mobile:static mobile:flex mobile:flex-col inline-flex col-span-2 items-center justify-center max-h-[550px] w-full">
            <img src="https://via.placeholder.com/664x514" class="w-full max-h-[550px]" alt="">
...
<div class="px-14 py-24 bg-[#F9F8F1]">
    ...
    <div class="grid grid-cols-3 justify-center gap-10 w-full mobile:block mt-16">
        ...
        <div class="relative mobile:static mobile:flex mobile:flex-col inline-flex col-span-2 space-y-10 items-center justify-center max-h-[600px]">
            <img src="https://via.placeholder.com/664x514" class="w-full max-h-full" alt="">
            <div class="absolute mobile:static mobile:!mt-0 mobile:h-[50%] w-[55%] mobile:w-full left-0 bottom-0 bg-[#F9F8F1] border border-[#E0DAB8]">
                <div class="flex flex-col px-8 pt-8">
                    <div class="font-bold text-3xl desktop:text-2xl leading-8 text-[#383A36] mb-4">
                        <p>Món quà từ những người phụ nữ trong gia đình</p>
                    </div>
