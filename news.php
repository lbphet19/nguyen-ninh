...
<div class="px-14 mobile:px-4 w-full mobile:mt-4 max-h-[27.75rem] h-[27.75rem] bg-[#F9F8F1]"
    ...
    <div class="flex pt-24 items-end justify-between">
        <div class="flex flex-col w-1/2 mr-[12.25rem]">
            ...
            <div class="inline-flex items-center justify-center w-full mt-8">
                <p
                    class="text-[5.25rem] laptop:text-7xl laptop:leading-[6rem] mobile:text-[3.5rem] mobile:!leading-[5rem] leading-[7rem] text-white font-prata mobile:text-center">
