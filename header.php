...
<body <?php body_class(); ?>>
    <div class="flex items-center justify-between px-14 py-5 w-full mobile:hidden">
        ...
        <a id="home" href = "<?php echo get_permalink( get_page_by_path( 'trang-chu' ) );?>">Nguyên Ninh</a>
        </p>
        <div class="flex items-center justify-center">
            <div
                class="flex flex-col items-center gap-1 mr-16 last:mr-0 text-[#383A36] tracking-widest uppercase font-raleway">
                <a id="product" href = "<?php echo get_permalink( get_page_by_path( 'san-pham' ) );?>">Sản phẩm</a>
            </div>
            <div
                class="flex flex-col items-center gap-1 mr-16 last:mr-0 text-[#383A36] tracking-widest uppercase font-raleway">
                <a id="about" href = "<?php echo get_permalink( get_page_by_path( 've-nguyen-ninh' ) );?>">Về Nguyên Ninh</a>
                </div>
            <div
                class="flex flex-col items-center gap-1 mr-16 last:mr-0 text-[#383A36] tracking-widest uppercase font-raleway">
                <a id="story" href = "<?php echo get_permalink( get_page_by_path( 'cau-chuyen' ) );?>">Câu chuyện</a>
                </div>
